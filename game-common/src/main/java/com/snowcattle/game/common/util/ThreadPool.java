...
public class ThreadPool {
    ...
    /*定时任务线程工厂*/
    private final ThreadFactory scheduleThreadFactory;
    ...
    public ThreadPool(int coreSize, int maxSize, int keepAliveTime, BlockingQueue<Runnable> workQueue, ThreadFactory threadFactory, RejectedExecutionHandler handler) {
        ...
        this.scheduleThreadFactory = new ThreadNameFactory(GlobalConstants.Thread.START_FINISHED);
    }
    ...
    public boolean start() {
        ...
        try {
            ...
            scheduledExecutorService = Executors.newScheduledThreadPool(coreSize, scheduleThreadFactory);
            if (logger.isInfoEnabled()) {
    ...
    public void addDelayTask(Runnable task, long delay, TimeUnit unit) {
